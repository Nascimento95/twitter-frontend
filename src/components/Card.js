      ...
      <div className="card">
        ...
        <div className="card-body">
            ...
            <div style={{width:"100%", display:"flex"}}>
              <Link to="/" ><p className='  list-group-item list-group-item-action'>Tweets</p></Link>
              <Link to="/" ><p className=' list-group-item list-group-item-action'>Tweets  replies</p></Link>
              <Link to="/" ><p className=' list-group-item list-group-item-action'>Media</p></Link>
              <Link to="/" ><p className=' list-group-item list-group-item-action'>Like</p></Link>
            </div>
        </div>
      </div>
    );
